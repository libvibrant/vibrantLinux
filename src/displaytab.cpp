...
displayTab::displayTab(QString name, QWidget *parent)
    : QWidget(parent), name(name) {
  makeTab();
}

displayTab::displayTab(const displayTab &other)
...
int displayTab::getSaturation() { return spinBox->value(); }

void displayTab::setSaturation(int saturation) {
  spinBox->setValue(saturation);
}

const QString &displayTab::getName() { return name; }

void displayTab::setName(QString name) { this->name = name; }
